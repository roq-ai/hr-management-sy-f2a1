  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Streamline Your Workflow with HR Management System: Centralizing Employee Data, Payroll, Time Tracking, and Performance Evaluations - All in One Place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Streamline Your Workflow with HR Management System: Centralizing Employee Data, Payroll, Time Tracking, and Performance Evaluations - All in One Place.`}
            </Text>
            <Box
